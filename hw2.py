"""
Суммируйте значения alt всех img на странице.

Цель: Написать код, который будет обрабатывать HTML-структуру,
состоящую из различных тегов, включая теги <img>. Код должен
находить все теги <img> и суммировать значения их атрибута alt.
"""
